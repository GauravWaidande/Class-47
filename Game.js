class Game {
  ...
  start(){
   ...
   stoneGroup = new Group();
      ...
      stone=createSprite(8485,525,500,35);
      ...
      player=createSprite(50,450,10,10);
      ...
      life=createSprite(1925,125,10,10);
      ...
      thorns=createSprite(998,443,10,10);
      thorns.addImage("t1",thornsImg);
      thorns.scale=0.9;

      skull=createSprite(stone4.x,285,10,10);
  ...
  setElementsPosition(){
    ...
    this.fireButton.position(5200,600);
  }
  ...
  handleControl(){
    ...
    skull.velocityX=-6;
    skull.setCollider("rectangle",0,0,200,400);
